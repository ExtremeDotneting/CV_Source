...
var defineGlobalProperty$3 = function(key, value) {
  try {
    defineProperty$5(global$f, key, { value, configurable: true, writable: true });
  } catch (error) {
    global$f[key] = value;
  }
  return value;
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$8 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O2, P) {
  ...
  if (hasOwn$9(O2, P))
    return createPropertyDescriptor$3(!call$f(propertyIsEnumerableModule.f, O2, P), O2[P]);
};
...
objectDefineProperty.f = DESCRIPTORS$6 ? V8_PROTOTYPE_DEFINE_BUG$1 ? function defineProperty(O2, P, Attributes) {
  anObject$f(O2);
  P = toPropertyKey$1(P);
...
var classof$6 = TO_STRING_TAG_SUPPORT ? classofRaw$1 : function(it) {
  var O2, tag, result;
  return it === void 0 ? "Undefined" : it === null ? "Null" : typeof (tag = tryGet(O2 = $Object$1(it), TO_STRING_TAG$1)) == "string" ? tag : CORRECT_ARGUMENTS ? classofRaw$1(O2) : (result = classofRaw$1(O2)) == "Object" && isCallable$a(O2.callee) ? "Arguments" : result;
};
...
if (!set || !clear) {
  ...
  } else if (global$8.addEventListener && isCallable$8(global$8.postMessage) && !global$8.importScripts && $location && $location.protocol !== "file:" && !fails$b(globalPostMessageDefer)) {
