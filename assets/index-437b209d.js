...
async function loadFonts() {
  const webFontLoader = await __vitePreload(() => import(
    ...
    "./webfontloader-232766be.js"
  ).then((n) => n.w), true ? ["assets/webfontloader-232766be.js","assets/_commonjsHelpers-7a77ea84.js"] : void 0);
  webFontLoader.load({
    google: {
...
let myColors = {
  ...
  skillChipColor0: "#009688",
  skillChipColor1: "#3f51b5",
...
export {
  Transition as $,
  getCurrentInstanceName as A,
  isRef as B,
  destructComputed as C,
  isCssColor as D,
  unref as E,
  Fragment as F,
  toRef as G,
  ...
  deepEqual as O,
  wrapInArray as P,
  findChildrenWithProvide as Q,
  mergeProps as R,
  toRefs as S,
  convertToUnit as T,
  useIcon as U,
  flattenFragments as V,
  Text as W,
  shallowRef as X,
  SUPPORTS_INTERSECTION as Y,
  watchEffect as Z,
  useRtl as _,
  propsFactory as a,
  ...
  hasEvent as a1,
  nextTick as a2,
  onScopeDispose as a3,
  isObject as a4,
  keyCodes as a5,
  onBeforeMount as a6,
  vShow as a7,
  createBlock as a8,
  createCommentVNode as a9,
  createTextVNode as aa,
  toDisplayString as ab,
  __vitePreload as ac,
  TransitionGroup as ad,
  toRaw as ae,
  defineComponent as af,
  EventProp as ag,
  deprecate as ah,
  focusChild as ai,
  getPropertyFromItem as aj,
  pick as ak,
  useToggleScope as al,
  clamp as am,
  effectScope as an,
  matchesSelector as ao,
  useDisplay as ap,
  Teleport as aq,
  omit as ar,
  focusableChildren as as,
  getNextElement as at,
  ...
  camelize as n,
  openBlock as o,
  provideDefaults as p,
  h as q,
  resolveDirective as r,
